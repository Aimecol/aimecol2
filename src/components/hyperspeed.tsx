...
const themePresets = {
  dark: {
    ...
    colors: {
      ...
      leftCars: [0xff6b35, 0xd77b35, 0xc85a23],
      rightCars: [0x004cff, 0x1e4d9e, 0x3a6bc9],
      sticks: 0xff6b35
    }
  },
  light: {
    ...
    colors: {
      ...
      background: 0xfafafa,
      shoulderLines: 0xc85a23,
      brokenLines: 0xd77b35,
      leftCars: [0xd77b35, 0xc85a23, 0xb64928],
      rightCars: [0x1e4d9e, 0x0e5ea5, 0x004cff],
      sticks: 0xd77b35
    }
  }
}
...
const Hyperspeed = ({
  ...
  // Merge theme-specific colors with any provided options
  ...
  useEffect(() => {
    ...
    const resizeRendererToDisplaySize = (renderer: THREE.WebGLRenderer, setSize: any) => {
